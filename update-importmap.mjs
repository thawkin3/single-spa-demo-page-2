...
const url = `https://single-spa-demo.s3-us-west-2.amazonaws.com/%40thawkin3/single-spa-demo-page-2/${process.env.TRAVIS_COMMIT}/thawkin3-single-spa-demo-page-2.js`;
  ...
  .get(url, res => {
    ...
    if (res.statusCode >= 200 && res.statusCode < 300) {
      if (
        ...
        const moduleName = `@thawkin3/single-spa-demo-page-2`;
